...
See: [threat-modeling-guide.md](threat-modeling-guide.md)
...
See: [security-architecture-patterns.md](security-architecture-patterns.md)
...
See: [cryptography-implementation.md](cryptography-implementation.md)
