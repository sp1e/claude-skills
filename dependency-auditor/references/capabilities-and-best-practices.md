# Capabilities, Architecture & Best Practices

Read this when you need the full breakdown of what the auditor analyzes, its scanner/analyzer/planner internals, use cases by team, advanced/enterprise features, recommended cadences, and the metrics to track.
