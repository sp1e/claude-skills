# Core Capabilities & Implementation Guidelines

Read this when selecting an architecture pattern, defining agent roles, designing tools/communication/guardrails, or planning evaluation, orchestration, memory, scaling, and failure handling for a multi-agent system.
