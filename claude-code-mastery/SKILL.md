...
description: >-
  ...
  skapa en ny skill. Trigga på "CLAUDE.md", "skriv en skill", "skill-frontmatter", "subagent",
  "allowed-tools", "hook", "settings.json", "kontextbudget", "token-budget", "för många
  skills", "slash-kommando", "permission mode", "MCP-server", "worktree".
license: MIT
metadata:
  version: 1.1.0
  author: borghei
