# Tooling, CI Integration, Best Practices, Troubleshooting & Tool Reference

Read this when wiring the tools into CI/pre-commit, applying the best-practice/anti-pattern checklists, troubleshooting, or needing full CLI flag references.
