...
Read this when reviewing or designing endpoints — naming, versioning, pagination, error formats, auth, rate limiting, HATEOAS, idempotency, backward compatibility, OpenAPI validation, performance, and security.
