# Design Audit Workflows & Operations

Read this when running an audit end to end: quick-start commands, the three workflows, the design-principles operating system, fix-session rules, CI/CD wiring, anti-patterns, and troubleshooting.
